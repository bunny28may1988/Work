...
/*
output "AMI-ID" {
  description = "AMI Id for the ADO Agent"
  value       = module.ADO-Agent[var.Resource.EC2.ADO-Agent_Name].instance_id
}
output "Private-IP" {
  description = "Private IP for the ADO-Agent"
  value       = module.ADO-Agent.private_ip
}*/